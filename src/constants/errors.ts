export default {
  ...
  alreadyExistingEntity: {
    ...
    paymentType: 'Payment type already exists',
    categories: 'Category already exists',
    stores: 'Store already exists',
  },
  alreadyExistingUpdateEntity: {
    banks: 'There is already a bank with same name',
    paymentType: 'There is already a payment type with same description',
    categories: 'There is already a category with same description',
    stores: 'There is already a store with same name',
  },
